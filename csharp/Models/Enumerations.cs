...
public static class CodigoMonedaExtension
{
    ...
    public static string GetSymbol(this CodigoMoneda value) => value switch
    {
        CodigoMoneda.AED => "د.إ",
        CodigoMoneda.AFN => "؋",
        CodigoMoneda.ALL => "L",
        CodigoMoneda.AMD => "֏",
        CodigoMoneda.ANG => "ƒ",
        ...
        CodigoMoneda.AZN => "₼",
        CodigoMoneda.BAM => "KM",
        CodigoMoneda.BBD => "Bds$",
        CodigoMoneda.BDT => "৳",
        CodigoMoneda.BGN => "лв",
        CodigoMoneda.BHD => ".د.ب",
        CodigoMoneda.BIF => "FBu",
        CodigoMoneda.BMD => "$",
        CodigoMoneda.BND => "$",
        CodigoMoneda.BOB => "Bs.",
        CodigoMoneda.BOV => "Mvdol",
        CodigoMoneda.BRL => "R$",
        CodigoMoneda.BSD => "$",
        CodigoMoneda.BTN => "Nu.",
        CodigoMoneda.BWP => "P",
        ...
        CodigoMoneda.CAD => "C$",
        CodigoMoneda.CDF => "FC",
        CodigoMoneda.CHF => "CHF",
        CodigoMoneda.CLF => "UF",
        CodigoMoneda.CLP => "$",
        CodigoMoneda.CNY => "¥",
        CodigoMoneda.COP => "$",
        CodigoMoneda.COU => "COU",
        CodigoMoneda.CRC => "₡",
        CodigoMoneda.CUC => "$",
        CodigoMoneda.CUP => "$",
        CodigoMoneda.CVE => "$",
        CodigoMoneda.CZK => "Kč",
        CodigoMoneda.DJF => "Fdj",
        CodigoMoneda.DKK => "kr",
        CodigoMoneda.DOP => "RD$",
        CodigoMoneda.DZD => "د.ج",
        CodigoMoneda.EGP => "£",
        CodigoMoneda.ERN => "Nfk",
        CodigoMoneda.ETB => "Br",
        CodigoMoneda.EUR => "€",
        CodigoMoneda.FJD => "FJ$",
        CodigoMoneda.FKP => "£",
        ...
        CodigoMoneda.ILS => "₪",
        CodigoMoneda.INR => "₹",
        CodigoMoneda.IQD => "ع.د",
        CodigoMoneda.IRR => "﷼",
        CodigoMoneda.ISK => "kr",
        CodigoMoneda.JMD => "J$",
        CodigoMoneda.JOD => "د.ا",
        CodigoMoneda.JPY => "¥",
        CodigoMoneda.KES => "KSh",
        CodigoMoneda.KGS => "сом",
        CodigoMoneda.KHR => "៛",
        CodigoMoneda.KMF => "CF",
        CodigoMoneda.KPW => "₩",
        CodigoMoneda.KRW => "₩",
        CodigoMoneda.KWD => "د.ك",
        CodigoMoneda.KYD => "$",
        CodigoMoneda.KZT => "₸",
        CodigoMoneda.LAK => "₭",
        CodigoMoneda.LBP => "ل.ل",
        CodigoMoneda.LKR => "₨",
        CodigoMoneda.LRD => "$",
        CodigoMoneda.LSL => "L",
        CodigoMoneda.LYD => "ل.د",
        CodigoMoneda.MAD => "د.م.",
        CodigoMoneda.MDL => "L",
        CodigoMoneda.MGA => "Ar",
        CodigoMoneda.MKD => "ден",
        CodigoMoneda.MMK => "K",
        CodigoMoneda.MNT => "₮",
        CodigoMoneda.MOP => "MOP$",
        CodigoMoneda.MRO => "UM",
        CodigoMoneda.MUR => "₨",
        CodigoMoneda.MVR => "Rf",
        CodigoMoneda.MWK => "MK",
        CodigoMoneda.MXN => "$",
        CodigoMoneda.MXV => "UDI",
        CodigoMoneda.MYR => "RM",
        CodigoMoneda.MZN => "MT",
        CodigoMoneda.NAD => "$",
        CodigoMoneda.NGN => "₦",
        ...
        CodigoMoneda.PYG => "₲",
        CodigoMoneda.QAR => "﷼",
        CodigoMoneda.RON => "lei",
        CodigoMoneda.RSD => "дин",
        CodigoMoneda.RUB => "₽",
        CodigoMoneda.RWF => "FRw",
        CodigoMoneda.SAR => "﷼",
        CodigoMoneda.SBD => "SI$",
        CodigoMoneda.SCR => "₨",
        CodigoMoneda.SDG => "ج.س.",
        CodigoMoneda.SEK => "kr",
        CodigoMoneda.SGD => "S$",
        CodigoMoneda.SHP => "£",
        CodigoMoneda.SLL => "Le",
        ...
        CodigoMoneda.TJS => "SM",
        CodigoMoneda.TMT => "T",
        CodigoMoneda.TND => "د.t",
        CodigoMoneda.TOP => "T$",
        CodigoMoneda.TRY => "₺",
        CodigoMoneda.TTD => "TT$",
        CodigoMoneda.TWD => "NT$",
        CodigoMoneda.TZS => "TSh",
        CodigoMoneda.UAH => "₴",
        CodigoMoneda.UGX => "USh",
        CodigoMoneda.USD => "$",
        CodigoMoneda.USN => "$",
        CodigoMoneda.UYI => "UI",
        CodigoMoneda.UYU => "$U",
        CodigoMoneda.UZS => "soʻm",
        CodigoMoneda.VEF => "Bs.F",
        CodigoMoneda.VND => "₫",
        CodigoMoneda.VUV => "VT",
        CodigoMoneda.WST => "WS$",
        CodigoMoneda.XAF => "FCFA",
        CodigoMoneda.XCD => "$",
        CodigoMoneda.XDR => "SDR",
        CodigoMoneda.XOF => "CFA",
        CodigoMoneda.XPF => "₣",
        CodigoMoneda.XSU => "Sucre",
        CodigoMoneda.XUA => "XUA",
        CodigoMoneda.YER => "﷼",
        CodigoMoneda.ZAR => "R",
        CodigoMoneda.ZMW => "ZK",
        CodigoMoneda.ZWL => "$",
