...
{
    private string _tipoDocumento = TipoComprobanteExtension.NotaDebitoElectronica;
    ...
    public NotaDebitoBuilder DeFactura(string claveFactura, DateTime fechaFactura, string razon, string codigo = CodigoReferenciaExtension.CorrigeMontoReferencia)
    {
    ...
    public NotaDebitoBuilder ConEmisor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaJuridica)
    {
    ...
    public NotaDebitoBuilder ConReceptor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaFisica)
    {
    ...
    public NotaDebitoBuilder ConConsecutivo(int establecimiento, int terminal, long numero)
    {
    ...
    public NotaDebitoBuilder AgregarLinea(string detalle, decimal cantidad, decimal precio, string codigoCabys, string unidadMedida = "Unid")
    {
    ...
    public NotaDebitoBuilder AgregarInformacionPago(string descripcion, string identificador, string otros)
    {
