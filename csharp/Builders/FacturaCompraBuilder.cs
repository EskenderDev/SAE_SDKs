...
{
    private string _tipoDocumento = TipoComprobanteExtension.FacturaElectronicaCompras;
    ...
    public FacturaCompraBuilder ConEmisor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaJuridica)
    {
    ...
    public FacturaCompraBuilder ConReceptor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaFisica)
    {
    ...
    public FacturaCompraBuilder ConConsecutivo(int establecimiento, int terminal, long numero)
    {
    ...
    public FacturaCompraBuilder AgregarLinea(string detalle, decimal cantidad, decimal precio, string codigoCabys, string unidadMedida = "Unid")
    {
    ...
    public FacturaCompraBuilder AgregarInformacionPago(string descripcion, string identificador, string otros)
    {
