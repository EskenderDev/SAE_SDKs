...
{
    private string _tipoDocumento = TipoComprobanteExtension.NotaCreditoElectronica;
    ...
    private List<InformacionReferenciaRequest> _referencias = new();
    private List<(string Descripcion, string Identificador, string Otros)> _informacionPago = new();

    public NotaCreditoBuilder DeFactura(string claveFactura, DateTime fechaFactura, string razon, string codigo = CodigoReferenciaExtension.AnulaDocumentoReferencia)
    {
        _referencias.Add(new InformacionReferenciaRequest(
            TipoDocumentoReferenciaExtension.FacturaElectronica,
            null,
            claveFactura,
            fechaFactura,
            codigo,
    ...
    public NotaCreditoBuilder ConEmisor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaJuridica)
    {
    ...
    public NotaCreditoBuilder ConReceptor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaFisica)
    {
    ...
    public NotaCreditoBuilder ConConsecutivo(int establecimiento, int terminal, long numero)
    {
    ...
    public NotaCreditoBuilder AgregarLinea(string detalle, decimal cantidad, decimal precio, string codigoCabys, string unidadMedida = "Unid")
    {
    ...
    public NotaCreditoBuilder ConImpuesto(string codigo, string tarifaIva, decimal tarifa)
    {
    ...
    public NotaCreditoBuilder AgregarInformacionPago(string descripcion, string identificador, string otros)
    {
    ...
    public GenerarDocumentoRequest Build()
    {
        ...
        return new GenerarDocumentoRequest
        {
            ...
            ResumenFactura = new ResumenFacturaRequest(
                ...
                null,
                totalComprobante),
            InformacionReferencia = _referencias,
            OtrosCargos = null,
