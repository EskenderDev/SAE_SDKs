...
{
    private string _tipoDocumento = TipoComprobanteExtension.FacturaElectronica;
    ...
    public FacturaBuilder ConEmisor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaJuridica)
    {
    ...
    public FacturaBuilder ConReceptor(string nombre, string numeroIdentificacion, string correo, string tipo = TipoIdentificacionExtension.CedulaFisica)
    {
    ...
    public FacturaBuilder ConConsecutivo(int establecimiento, int terminal, long numero)
    {
    ...
    public FacturaBuilder AgregarLinea(string detalle, decimal cantidad, decimal precio, string codigoCabys, string unidadMedida = "Unid")
    {
    ...
    public FacturaBuilder ConImpuesto(string codigo, string tarifaIva, decimal tarifa)
    {
        ...
        ultimaLinea.Impuestos.Add(new ImpuestoRequest(
            ...
            Monto: null, // Dejar que el API lo calcule o calcularlo aquí
            Exoneracion: null
        ));
    ...
    public FacturaBuilder AgregarInformacionPago(string descripcion, string identificador, string otros)
    {
    ...
    public GenerarDocumentoRequest Build()
    {
        ...
        foreach (var linea in _lineas)
        {
            ...
            // Simple tax calculation for SDK
            ...
            // Categorize for summary (very primitive, API will refine)
            if (impuestoLinea > 0)
            {
                // Simple logic: assume "Unid" is Mercancia, others might be Service
        ...
        return new GenerarDocumentoRequest
        {
            ...
            ResumenFactura = new ResumenFacturaRequest(
                ...
                null, // API will calculate breakdown
                totalImpuesto, 0, 0, 0,
                null,
                totalComprobante),
