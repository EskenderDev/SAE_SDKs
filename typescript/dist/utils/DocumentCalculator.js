...
exports.DocumentCalculator = void 0;
class DocumentCalculator {
     ...
     */
    static roundHacienda(value, decimals = 5) {
     ...
     */
    static calculateLineItem(linea) {
     ...
     */
    static calculateLines(lineas) {
        return lineas.map(l => this.calculateLineItem(l));
    }
}
exports.DocumentCalculator = DocumentCalculator;
